...
public class EmailService {
    ...
    public void sendVerifyOtp(String username, String email, String otp) throws MessagingException {
        ...
        sendSmtpEmail.setSender(new SendSmtpEmailSender().name("ResumeIQ").email("a1b2c3d4w7x8y9z0@gmail.com"));
    ...
    public void sendResetOtp(String username, String email, String otp) throws MessagingException {
